...
public abstract class StrutsConventionSpringJUnit4TestCase {
	...
	private static final String CONFIG_LOCATIONS = "spring-module.xml";
	...
	protected ActionProxy getActionProxy(String uri) {
		...
		ActionMapping mapping = Dispatcher.getInstance().getContainer().getInstance(ActionMapper.class)
		...
		proxy = dispatcher.getContainer().getInstance(ActionProxyFactory.class).createActionProxy(namespace, name,
				method, new HashMap<String, Object>(), true, false);
